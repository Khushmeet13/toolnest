...
export default function HeroSection() {
    return (
        <div className="bg-white pt-16 dark:bg-gray-900">
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                <div className="mx-auto max-w-2xl sm:text-center">
                    <h2 className="text-base/7 font-semibold text-cyan-600 dark:text-indigo-400">Everything you need</h2>
                    <p className="mt-2 text-4xl font-medium tracking-tight text-pretty text-gray-900 sm:text-5xl sm:text-balance dark:text-white">
                        Convert Anything, Anytime.
                    </p>
                    <p className="mt-4 text-lg/8 text-gray-600 dark:text-gray-300">
                        ToolNest provides fast, secure, and reliable file and unit conversion tools —
                        all in one place. No installation required. Just upload and convert instantly.
                    </p>
                </div>
            </div>
