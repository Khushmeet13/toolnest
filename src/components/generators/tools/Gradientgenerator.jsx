...
export default function GradientGenerator() {
  ...
  return (
    <>
      ...
      <div className="gg min-h-screen flex flex-col py-16">
        <h1 className="text-4xl font-semibold text-gray-900 text-center mb-2">
          Design Stunning <span className="text-cyan-600">Gradients</span> Effortlessly
        </h1>
        <p className="text-gray-500 text-center max-w-2xl mx-auto mb-10">
          Build linear, radial, and conic gradients with full control over color stops, direction, and presets. Preview in real-time and export clean CSS or React code instantly.
        </p>

        {/* ── BODY ── */}
        <div className="flex-1 flex flex-col lg:flex-row gap-0 overflow-hidden max-w-7xl mx-auto border border-gray-200 rounded-xl">
