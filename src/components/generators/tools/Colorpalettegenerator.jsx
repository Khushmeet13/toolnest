...
export default function ColorPaletteGenerator() {
  ...
  return (
    <>
      ...
      <div className="ins max-w-6xl mx-auto min-h-screen bg-white flex flex-col">
        ...
        <div className="bg-white border-b border-gray-200 flex flex-wrap items-center gap-2.5 px-6 py-3">
          ...
          <button onClick={generate}
            className="flex items-center gap-2 bg-gray-900 text-white text-[13px] font-semibold px-5 py-2 rounded-lg hover:bg-gray-700 transition-colors cursor-pointer border-0"
          >
          ...
          <div className="bg-white border-t border-gray-200 px-6 pt-5 pb-6">
            ...
            <div className="relative">
              ...
              <button onClick={copyExport}
                className="absolute top-2.5 right-2.5 bg-gray-900 text-white text-xs font-semibold px-3 py-1.5 rounded-md hover:bg-gray-700 cursor-pointer border-0 transition-colors"
              >Copy</button>
            </div>
            {/* color strip */}
